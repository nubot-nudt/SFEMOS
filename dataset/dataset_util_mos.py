...
from dataset.dataset_mos import KITTIDataset, KITTIEvalDataset, HAOMOEvalDataset
...
def make_train_collate_fn(dataset):
    ...
    def collate_fn(data_list):
        ...
        batch_mos = torch.stack(mos, dim=0)       # Produces (batch_size, n_points, 3) tensor
